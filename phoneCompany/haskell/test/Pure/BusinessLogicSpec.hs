...
callTest1 = [standardCallTest1, standardCallTest2, standardCallTest3,
            overflowCallTest1, overflowCallTest2, overflowCallTest3]
  ...
  describe "filterLongerCall" $ do
    ...
    describe "businessLogic" $ do
      ...
      it "should return the expected invoice given a specific input 2" $
        businessLogic (fromList callTest2) `shouldBe` fromList [
