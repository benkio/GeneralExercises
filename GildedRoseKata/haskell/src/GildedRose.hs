...
itemRefinement (Item "Conjured Mana Cake" s q) = SpecialItem $ Conjured (SellIn s) $ Quality q
...
itemWiden (SpecialItem (Conjured (SellIn s) (Quality q))) = Item "Conjured Mana Cake" s q
