module TwentyFifteen.December07 where
...
december07Solution1 :: IO Word16
december07Solution1 = solution1 "a" <$> input

december07Solution2 :: IO Word16
december07Solution2 = do
    i <- input
    a <- december07Solution1
    let newB = ASSIGN "b" a
