module TwentySixteen.December08 where
...
december08Solution1 = countLitPixels . solution initialGrid <$> input

december08Solution2 :: IO String
december08Solution2 = showGrid . solution initialGrid <$> input
