module TwentySixteen.December22 where
...
december22Solution1 = length . solution1 . fmap snd . toList <$> input
...
december22Solution2 = input <&> \x -> solution2 [] (target, x) startingHistory
  where
