module TwentyTwentyOne.December05 where
...
december05Solution1 = countOverlapCoordinates . computeAllCoordinates . parseInput <$> input
...
december05Solution2 = countOverlapCoordinates . computeAllCoordinates' . parseInput <$> input
