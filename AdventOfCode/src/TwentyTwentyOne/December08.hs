module TwentyTwentyOne.December08 where
...
december08Solution1 = sum . fmap (solution1 (\d i -> fst (buildDictionary d i))) <$> input
...
december08Solution2 = sum . fmap (solution2 buildDictionary') <$> input
