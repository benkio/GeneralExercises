module TwentyTwentyOne.December04 where
...
december04Solution1 = calculateScore . uncurry gameLoop . parseInput <$> input
...
december04Solution2 = calculateScore . uncurry gameLoop' . parseInput <$> input
